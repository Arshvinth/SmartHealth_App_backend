...
import { cancelAppointment, getPatientVisits, getUserAppointments, scheduleAppointment } from "../controllers/appointmentController.js";
...
appointmentRouter.get("/visits", getPatientVisits);
